...
{
        volatile unsigned int * gpio_1 = GPIO1_BASE;
        gpio_1[GPIO_OE/4] &= ~LED_BIT;
}
...
void blink()
{
        ...
        unsigned int inverted_bit_val = ( (gpio[ (GPIO_DATAOUT/4)] ^ (LED_BIT)) >> LED_PIN) & 0x1  ;
